...
Route::group(['prefix' => 'admin'], function () {
    ...
    Route::group(['middleware' => 'admin.auth'], function () {
        ...
        // academic year
        Route::get('academic-year', [AcademicYearController::class, 'read'])->name('academic-year.read');
        ...
        Route::get('announcement', [AnnouncementController::class, 'read'])->name('announcement.read');
        ...
        // classes management
        Route::get('class', [ClassesController::class, 'read'])->name('class.read');
        ...
        // fee head management
        Route::get('fee-head', [FeeHeadController::class, 'read'])->name('fee-head.read');
        ...
        Route::get('fee-structure', [FeeStructureController::class, 'read'])->name('fee-structure.read');
        ...
        // student management
        Route::get('student', [StudentController::class, 'read'])->name('student.read');
        ...
        // subject
        Route::get('subject', [SubjectController::class, 'read'])->name('subject.read');
        ...
        Route::get('assign-subject', [AssignSubjectToClassController::class, 'read'])->name('assign-subject.read');
        ...
        Route::get('assign-subject/{id}/edit', [AssignSubjectToClassController::class, 'edit'])->name('assign-subject.edit');
        ...
        // teacher management
        Route::get('teacher', [TeacherController::class, 'read'])->name('teacher.read');
        ...
        // assign teacher 
        Route::get('assign-teacher', [AssignTeacherToClassController::class, 'read'])->name('assign-teacher.read');
        ...
        Route::get('assign-teacher/{id}/edit', [AssignTeacherToClassController::class, 'edit'])->name('assign-teacher.edit');
        ...
        // time table 
        Route::get('timetable', [TimetableController::class, 'read'])->name('timetable.read');
